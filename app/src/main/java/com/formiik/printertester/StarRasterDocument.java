...
public class StarRasterDocument {
	...
	public StarRasterDocument(RasSpeed speed, RasPageEndMode endOfPageBehaviour, RasPageEndMode endOfDocumentBahaviour, RasTopMargin topMargin, int pageLength, int leftMargin, int rightMargin) {
		mSpeed = speed;
